...
/* This file needs to support both SONOS and eCT flash. The FLASHC V2 IP block can
*  support either, so we use the CPUSS_FLASHC_ECT to determine which variation of the
*  register structures and defines to include in the build.
*/
...
#endif /* defined(CPUSS_FLASHC_ECT) && (CPUSS_FLASHC_ECT == 1) */
