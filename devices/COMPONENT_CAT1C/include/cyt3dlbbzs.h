...
#ifndef _CYT3DLBBZS_H_
#define _CYT3DLBBZS_H_

/**
* \addtogroup group_device CYT3DLBBZS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT3DLBBZS User Interrupt Numbers */
  ...
  /* CYT3DLBBZS Internal SW Interrupt Numbers */
...
/* CYT3DLBBZS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE87E130BUL
...
#include "gpio_tviic2d4m_272_bga.h"
