...
#ifndef _CYT3DLABZS_H_
#define _CYT3DLABZS_H_

/**
* \addtogroup group_device CYT3DLABZS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT3DLABZS User Interrupt Numbers */
  ...
  /* CYT3DLABZS Internal SW Interrupt Numbers */
...
/* CYT3DLABZS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE87F130BUL
