...
#ifndef _CYT3DLBBSS_H_
#define _CYT3DLBBSS_H_

/**
* \addtogroup group_device CYT3DLBBSS
* \{
*/
...
typedef enum {
  ...
  SysTick_IRQn                      =  -1,      /*!<  -1 System Tick Timer */
#endif
  /* CYT3DLBBSS User Interrupt Numbers */
  ...
  /* CYT3DLBBSS Internal SW Interrupt Numbers */
...
/* CYT3DLBBSS peripheral interrupts */
typedef enum {
...
#define CY_SILICON_ID                   0xE870130BUL
